        ...
        <main className="main__container">
          ...
          <section className="profile__info">
            ...
            <ul className="profile__container">
              <li>Age: 30</li>
              <li>Description: Cool person who never lies, I like sausage</li>
              <li>Gender: {userProfile[0]?.gender ?? "Not sure"}</li>
              <li>City: Bergen</li>
              <li>Disability: Hearing Impairment</li>
              <li>Gender Intrest: Not picky</li>
              <li>Hobbies: Reading, Basketball, Netflix & Chill</li>
              <li>Intrests: {userProfile[0]?.interests}</li>
            </ul>
          </section>
